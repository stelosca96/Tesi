...
\usepackage{amsmath}
\usepackage{dirtree}
\usepackage{listingsutf8}             % Include the listings-package per il codice
\lstset{
    basicstyle=\ttfamily\small,
    extendedchars=false,
    inputencoding=utf8,
    escapeinside={\%*}{*)},
    literate={á}{{\'a}}1 {é}{{\'e}}1 {ó}{{\'o}}1 {ú}{{\'u}}1
}
% \lstset{
%     escapeinside={\%*}{*)},
%      literate={á}{{\'a}}1 {í}{{\'i}}1 {é}{{\'e}}1 {ú}{{\'u}}1 {ó}{{\'o}}1    
% }
...
\definecolor{delim}{RGB}{153,153,153}
...
\include{capitoli/ddos}
\include{capitoli/anomaly_detection}
\include{capitoli/il_mio_lavoro}
