...
\uline{Inoltre oltre ad analizzare i risultati dei test controllo che il modello approssimi veramente i dati in ingresso e che i buoni risultati non siano dovuti solo a valori di soglie calcolate durante l'allenamento molto alte.}
