...
% TODO: mancano i dati di 40-6-40
\begin{table}
...
\paragraph{Reti LSTM} I risultati dei test relativi alle reti con nodi LSTM sono visibili nella tabella \ref{table:dense_tests}.
% todo: mettere tabella, i test forse sono da rifare
