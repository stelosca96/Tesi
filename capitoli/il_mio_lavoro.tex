...
Di tutte le feature viene poi calcolato il valore medio su un tempo di 10/30s, per avere dei valori confrontabili tra lavoro.
...
\begin{table}
    \begin{tabularx}{\textwidth}{||c c c c X X||} 
        ...
        \hline
        15 & 18/05/21 & 13.49 & 14.00 & Picco di connessioni (2500) & NO (/dipende) \\ %todo: prendere una decisione sul dipende        
        \hline 
