\chapter{Stato dell'arte dei sistemi anti-DDoS}
...
\begin{figure}[]
    ...
    \includegraphics[width=\hsize]{images/ddos/grafico_difese.png}
    \caption{Meccanismi di difesa contro DDoS di tipo flooding \cite{ddos_survey_1}}
    \centering
\end{figure}
